...
def test_lens_evaluation_measures_quality_and_safety_deterministically() -> None:
    ...
    assert first == {
        ...
        "current_database_exact_replay": True,
        "self_consistent_tamper_replay_mismatch": True,
        "in_scope_corpus_drift_replay_mismatch": True,
        "canonical_filter_and_foreign_mission_stability": True,
        "canonical_unicode_exact_replay": True,
        "empty_filter_isolation": True,
        "determinism": True,
        "mission_isolation": True,
        "unauthorized_mutation_count": 0,
        "fixture_mission_count": 2,
        "fixture_source_count": 8,
        "query_count": 3,
        "result_count": 4,
